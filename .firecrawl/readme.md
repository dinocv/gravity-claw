...
![](https://capsule-render.vercel.app/api?type=waving&color=0:4F46E5,100:7C3AED&height=180&section=header&text=%F0%9F%A6%9E%20177%20OpenClaw%20Agent%20Templates&fontSize=36&fontColor=ffffff&fontAlignY=35)

\### Skip the setup. Deploy in 60 seconds.

\*\*\[Browse all 177 templates →\](https://crewclaw.com/agents?utm\_source=github&utm\_medium=readme&utm\_campaign=browse)\*\* · \*\*\[Deploy in 60 seconds →\](https://crewclaw.com/create-agent?utm\_source=github&utm\_medium=readme&utm\_campaign=deploy)\*\*
...
\> \*\*Skip the setup?\*\* \[CrewClaw\](https://crewclaw.com/create-agent?utm\_source=github&utm\_medium=readme&utm\_campaign=skip\_setup) generates a full deploy package (Dockerfile + docker-compose + bot + README) for any role.
...
Or skip setup entirely: \*\*\[Deploy with CrewClaw →\](https://crewclaw.com/create-agent?utm\_source=github&utm\_medium=readme&utm\_campaign=quickstart)\*\* — get a full deploy package (Dockerfile + docker-compose + bot + README) for any role.
...
\*\*\[Create your agent →\](https://crewclaw.com/create-agent?utm\_source=github&utm\_medium=readme&utm\_campaign=bottom\_cta)\*\*
...
Built a custom agent? Get it listed here and on \[crewclaw.com/agents\](https://crewclaw.com/agents?utm\_source=github&utm\_medium=readme&utm\_campaign=submit).
...
[Deploy your agent with CrewClaw →](https://crewclaw.com/agents?utm_source=github&utm_medium=readme&utm_campaign=bottom_cta) · [Submit yours →](https://github.com/mergisi/awesome-openclaw-agents/issues/new?template=agent-submission.md)